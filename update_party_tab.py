...
if 'SearchIcon' not in content:
    content = content.replace("import PublishIcon from '@mui/icons-material/Publish';",
                              "import PublishIcon from '@mui/icons-material/Publish';\nimport SearchIcon from '@mui/icons-material/Search';")
if 'InputAdornment' not in content:
    content = content.replace("import {", "import { InputAdornment, List, ListItem, ListItemText, ListItemIcon, ", 1)
