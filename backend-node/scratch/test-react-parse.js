...
// Copy logic from CementRegister.jsx
...
console.log("Total parsed rows:", mappedRows.length);
console.log("First parsed row:", JSON.stringify(mappedRows[0], null, 2));
console.log("Second parsed row:", JSON.stringify(mappedRows[1], null, 2));
