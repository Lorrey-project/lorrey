...
console.log("Total filtered rows for March 2026:", filteredRows.length);
if (filteredRows.length > 0) {
  console.log("Filtered row #0:", JSON.stringify(filteredRows[0], null, 2));
  console.log("Filtered row #1:", JSON.stringify(filteredRows[1], null, 2));
}
