...
async function getBillRegisterData({ fy } = {}) {
  ...
  for (const r of Object.values(aggregated)) {
    ...
    finalRows.push({
      ...
      originalDebitAmount: ov.originalDebitAmount,
      totalAllocatedAmount: ov.totalAllocatedAmount || 0,
      remainingDebitAmount: ov.remainingDebitAmount,
      deductionAllocations: ov.deductionAllocations || [],
      isManual: false,
      slNo: ov.slNo,
