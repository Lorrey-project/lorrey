            ...
            <tbody>
              ...
              {data.map((t, i) => (
                <tr key={t.truckNo} style={{ background: i % 2 === 0 ? '#fff' : '#f8fafc' }}>
                  ...
                  {/* NVL */}
                  <td style={{ ...tdBase, background: 'rgba(237,233,254,0.3)' }}>{t.nvl.invQty || ''}</td>
                  ...
                  {/* NVCL */}
                  <td style={{ ...tdBase, background: 'rgba(220,252,231,0.3)' }}>{t.nvcl.invQty || ''}</td>
                  ...
                  <tbody>
                    {data.map(t => (
                      <tr key={t.truckNo}>
                        ...
                        <td style={{ ...tdBase, background: '#f8fafc' }}>{t.nvl.invQty || ''}</td>
                        <td style={{ ...tdBase, background: '#f8fafc' }}>{fmt(t.nvl.amt)}</td>
                        <td style={{ ...tdBase, background: '#f1f5f9' }}>{t.nvcl.invQty || ''}</td>
